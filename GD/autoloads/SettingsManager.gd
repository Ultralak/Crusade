...
var save_file_game = "settings_data.tres"
...
func load_settings():
	...
	if ResourceLoader.exists(save_settings_path + save_file_game):
		settings_data = ResourceLoader.load(save_settings_path + save_file_game)
...
func set_window_mode(window_mode : int, window_mode_index : int):
	...
	match window_mode:
		DisplayServer.WINDOW_MODE_WINDOWED:
			DisplayServer.window_set_mode(DisplayServer.WINDOW_MODE_WINDOWED, main_window)
		DisplayServer.WINDOW_MODE_FULLSCREEN:
			DisplayServer.window_set_mode(DisplayServer.WINDOW_MODE_FULLSCREEN, main_window)
		DisplayServer.WINDOW_MODE_MINIMIZED:
			DisplayServer.window_set_mode(DisplayServer.WINDOW_MODE_MINIMIZED, main_window)
		DisplayServer.WINDOW_MODE_MAXIMIZED:
			DisplayServer.window_set_mode(DisplayServer.WINDOW_MODE_MAXIMIZED, main_window)
		_:
			DisplayServer.window_set_mode(DisplayServer.WINDOW_MODE_FULLSCREEN, main_window)
...
func save_settings():
	ResourceSaver.save(settings_data, save_settings_path + save_file_game)			
