...
var enemy_attacking_player : Sprite2D  = null
var projectile_attacking_player : AnimatedSprite2D = null
var direction : int
...
func enter():
	...
	projectile_attacking_player = EnemyManager.attacking_projectile
	if enemy_attacking_player:
		direction = enemy_attacking_player.direction
